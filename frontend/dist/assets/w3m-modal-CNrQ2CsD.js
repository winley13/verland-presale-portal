import{aw as k,aR as le,R as c,C as pe,c as v,r as V,a as f,i as g,b as d,n as l,a1 as $,A as H,a2 as u,e as me,k as w,v as B,$ as U,aM as fe,aC as F,E as K,at as A,s as M,g as we,S as E,ay as z,aJ as oe,a0 as be,U as ce,aS as ge,aT as ye}from"./index-Cspv9acF.js";import{P as D}from"./index-KBfzVV5i.js";import{S as ve}from"./SwapController-CGPByv7w.js";import"./ui-vendor-v3QJ5Cvk.js";import"./utils-vendor-COyYjcU6.js";import"./router-vendor-CCFckGes.js";import"./query-vendor-zvy22aj4.js";const de={isUnsupportedChainView(){return c.state.view==="UnsupportedChain"||c.state.view==="SwitchNetwork"&&c.state.history.includes("UnsupportedChain")},async safeClose(){if(this.isUnsupportedChainView()){k.shake();return}if(await le.isSIWXCloseDisabled()){k.shake();return}(c.state.view==="DataCapture"||c.state.view==="DataCaptureOtpConfirm")&&pe.disconnect(),k.close()}},xe=v`
  :host {
    display: block;
...
`;var P=function(e,t,i,r){var a=arguments.length,o=a<3?t:r===null?r=Object.getOwnPropertyDescriptor(t,i):r,n;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")o=Reflect.decorate(e,t,i,r);else for(var s=e.length-1;s>=0;s--)(n=e[s])&&(o=(a<3?n(o):a>3?n(t,i,o):n(t,i))||o);return a>3&&o&&Object.defineProperty(t,i,o),o};const Re={lg:"lg-regular",md:"md-regular",sm:"sm-regular"},Ae={lg:"lg",md:"md",sm:"sm"};let I=class extends g{constructor(){super(...arguments),this.imageSrc="",this.text="",this.size="lg",this.type="text-dropdown",this.disabled=!1}render(){return d`<button ?disabled=${this.disabled} data-size=${this.size} data-type=${this.type}>
    ...
    </wui-flex>`}};I.styles=[V,me,Ie];P([l()],I.prototype,"imageSrc",void 0);P([l()],I.prototype,"text",void 0);P([l()],I.prototype,"size",void 0);P([l()],I.prototype,"type",void 0);P([l({type:Boolean})],I.prototype,"disabled",void 0);I=P([f("wui-select")],I);const Ee=v`
  wui-image {
